...
export default function DeferredClient({ children, fallback = null, rootMargin = '200px', minHeight = '0px', once = true }: DeferredClientProps): ReactElement {
  ...
  return <div ref={ref} style={{ minHeight }}>{visible ? children : fallback}</div>;
}
