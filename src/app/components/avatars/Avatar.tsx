...
export interface HairConfig { style: HairStyle; color?: string | undefined }
export interface BackgroundGradient { from: string; to: string }
...
function renderHair(style: HairStyle, color: string): React.ReactNode {
  ...
  switch(style){
    ...
    case 'buzz':
      return <path {...common} d="M30 54c5-16 24-28 46-22 15 4 24 15 28 27-10-9-25-14-40-14s-30 5-34 9z" opacity={0.9}/>;
    case 'short':
      return <path {...common} d="M29 56c4-18 26-34 50-28 17 4 30 18 32 34-12-10-26-16-41-16s-29 4-41 10z" />;
    case 'wavy':
      return <path {...common} d="M28 57c6-20 29-36 51-29 18 6 28 19 32 36-9-6-19-10-28-11-9-2-14 4-22 3-8-1-19 4-33 1z" />;
    case 'curly':
      return <path {...common} d="M30 58c4-14 18-30 38-28 23 2 36 20 38 36-8-8-15-12-22-13-7-1-11 5-18 4s-17 6-23 6-10-2-13-5z" />;
    case 'long':
      return <path {...common} d="M32 56c6-18 25-32 46-29 18 3 30 16 34 33 2 13-1 27-4 36l-8-4c3-11 2-21-2-30-3-6-7-11-12-12-7-2-15 3-23 2-8-1-20 4-26 4-1 9-1 19 3 29l-7 3c-5-11-5-25-1-32z" />;
    case 'bun':
      return <g fill={color}>
...
function renderMouth(mood: Mood): React.ReactNode {
  switch(mood){
    case 'neutral': return <path d="M54 92c6 3 14 3 20 0" stroke="#663300" strokeWidth={3} strokeLinecap="round" fill="none" />;
    case 'smile': return <path d="M52 90c8 8 20 8 28 0" stroke="#663300" strokeWidth={3} strokeLinecap="round" fill="none" />;
    case 'grin':
      return <g strokeLinecap="round" strokeWidth={3} fill="none" stroke="#663300"><path d="M50 88c10 12 22 12 32 0" /><path d="M56 90c2 3 4 4 8 4 4 0 6-1 8-4" strokeWidth={2} /></g>;
    default: return null;
  }
}

const Avatar: React.FC<AvatarProps> = memo(function Avatar({ name, skinTone, hair, mood, background, size=96, className='', shadow=true, ...rest }) {
  const hairOverride: HairConfig | undefined = hair ? { style: hair.style as HairStyle, ...(hair.color ? { color: hair.color } : {}) } : undefined;
  ...
  return (
    ...
    >
      ...
      <rect x={0} y={0} width={128} height={128} rx={16} fill={`url(#${titleId+'-bg'})`} filter={shadow?`url(#${titleId+'-shadow'})`:undefined} />
      {/* Shoulders / shirt */}
